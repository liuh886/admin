(() => {
  ...
  const copy = {
    zh: {
      ...
      freeBenefit: '链接长期有效。你成为 Pro 后，符合条件的新用户可通过它获得 Pro 体验。',
      joined: '已加入',
      trials: '已领取 Pro',
      copyLink: '复制链接',
      copied: '已复制',
    ...
    en: {
      ...
      freeBenefit: 'Your link stays valid. If you become Pro, eligible new users can receive a Pro trial through it.',
      joined: 'Joined',
